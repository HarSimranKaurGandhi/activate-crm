...
<body>
  <div class="page">
    ...
    <div class="content">
      ...
      <?php endif; ?>
      <?php if($quotation['show_brand_banner'] && ($company['brand_banner']['logo_src'] || $company['brand_banner']['name'])): ?>
        <div class="brand-banner">
          <div class="brand-banner-inner">
            <?php if($company['brand_banner']['logo_src']): ?>
              <img class="brand-banner-logo" src="<?php echo e($company['brand_banner']['logo_src']); ?>" alt="<?php echo e($company['brand_banner']['name'] ?: 'Brand Banner'); ?>">
            <?php endif; ?>
            <?php if($company['brand_banner']['name']): ?>
              <div class="brand-banner-name"><?php echo e($company['brand_banner']['name']); ?></div>
            <?php endif; ?>
          </div>
        </div>
      <?php endif; ?>
              ...
              <div class="meta-card">
                <table>
                  ...
                  <tr class="meta-row">
                    ...
                    <td class="meta-value"><?php echo e($quotation['number']); ?></td>
                  </tr>
                  <tr class="meta-row">
                    <td class="meta-label">Validity</td>
                    <td class="meta-value"><?php echo e($quotation['validity_label']); ?></td>
                  </tr>
                </table>
              </div>
            </td>
          ...
          <table class="items-table">
            ...
            <thead>
              <tr class="items-page-gap">
                <th style="width: <?php echo e($columnWidths['no']); ?>;"></th>
                <th style="width: <?php echo e($columnWidths['product']); ?>;"></th>
                <th style="width: <?php echo e($columnWidths['specs']); ?>;"></th>
                <th style="width: <?php echo e($columnWidths['price']); ?>;"></th>
                <th style="width: <?php echo e($columnWidths['qty']); ?>;"></th>
                <?php if($quotation['show_discount']): ?> <th style="width: <?php echo e($columnWidths['discount']); ?>;"></th> <?php endif; ?>
                <?php if($quotation['show_item_wise_gst']): ?> <th style="width: <?php echo e($columnWidths['gst']); ?>;"></th> <?php endif; ?>
                <th style="width: <?php echo e($columnWidths['total']); ?>;"></th>
              </tr>
              <tr>
                <th class="center col-no" style="width: <?php echo e($columnWidths['no']); ?>;">SNo</th>
                <th class="center col-product" style="width: <?php echo e($columnWidths['product']); ?>;">Product / Picture</th>
                <th class="col-specs" style="width: <?php echo e($columnWidths['specs']); ?>;">Specifications</th>
                <th class="right col-price" style="width: <?php echo e($columnWidths['price']); ?>;">Price</th>
                <th class="center col-qty" style="width: <?php echo e($columnWidths['qty']); ?>;">Qty</th>
                <?php if($quotation['show_discount']): ?> <th class="center col-discount" style="width: <?php echo e($columnWidths['discount']); ?>;">Disc%</th> <?php endif; ?>
                <?php if($quotation['show_item_wise_gst']): ?> <th class="right col-gst" style="width: <?php echo e($columnWidths['gst']); ?>;">GST</th> <?php endif; ?>
                <th class="right col-total" style="width: <?php echo e($columnWidths['total']); ?>;"><?php echo e($quotation['gst_inclusive'] ? 'Amount' : 'Net Amount'); ?></th>
              </tr>
            </thead>
            <tbody>
              <?php $__currentLoopData = $quotation['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td class="item-no col-no" style="width: <?php echo e($columnWidths['no']); ?>;"><?php echo e($index + 1); ?></td>
                  <td class="center col-product" style="width: <?php echo e($columnWidths['product']); ?>;">
                  ...
                  <td class="specs col-specs" style="width: <?php echo e($columnWidths['specs']); ?>;"><?php echo $item['specifications_html']; ?></td>
                  <td class="right amount-strong col-price" style="width: <?php echo e($columnWidths['price']); ?>;"><?php echo e($quotation['show_mrp'] ? $item['edited_price_label'] : $item['discounted_price_label']); ?></td>
                  <td class="center amount-strong col-qty" style="width: <?php echo e($columnWidths['qty']); ?>; white-space: nowrap;"><?php echo e($item['quantity_with_unit_label']); ?></td>
                  <?php if($quotation['show_discount']): ?> <td class="center col-discount" style="width: <?php echo e($columnWidths['discount']); ?>; white-space: nowrap;"><?php echo e($item['discount_percent_label']); ?></td> <?php endif; ?>
                  <?php if($quotation['show_item_wise_gst']): ?> <td class="right col-gst" style="width: <?php echo e($columnWidths['gst']); ?>;"><div><?php echo e($item['gst_percent_label']); ?></div><div class="gst-sub"><?php echo e($item['tax_amount_label']); ?></div></td> <?php endif; ?>
                  <td class="right amount-strong col-total" style="width: <?php echo e($columnWidths['total']); ?>;"><?php echo e($quotation['gst_inclusive'] ? $item['line_total_label'] : $item['net_amount_label']); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
          </table>
