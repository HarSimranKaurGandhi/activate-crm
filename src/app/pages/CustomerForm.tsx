            ...
            <div>
              ...
              <div className="flex">
                ...
                <input
                  ...
                  className={`w-full rounded-r-xl border px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                    errors.phone?.[0] ? 'border-red-500' : 'border-gray-200'
                  }`}
                />
              </div>
