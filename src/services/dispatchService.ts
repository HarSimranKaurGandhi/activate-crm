...
export const dispatchService={
  ...
  async cancel(id:string){return unwrap<any>(await apiClient.patch(`/dispatches/${id}/cancel`));},
  async remove(id:string){return unwrap<any>(await apiClient.delete(`/dispatches/${id}`));},
};
